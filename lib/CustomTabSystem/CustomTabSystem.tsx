...
const CustomTabSystem: React.FC<TabSystemProps> = ({
   ...
   return (
      <div className="w-full drop-shadow">
         {/* Tab Headers */}
         <div ref={tabsWrapperRef} className="relative border-b border-gray-200 overflow-hidden select-none">
            {/* Left Arrow */}
            <button
               type="button"
               className={`${
            ...
            >
               ...
               <div className="bg-gradient-to-r from-gray-100 to-transparent w-4 group-hover:w-6 transition-width duration-400 h-full" />
            </button>
            ...
            >
               <div className="bg-gradient-to-l from-gray-100 to-transparent w-4 group-hover:w-6 transition-width duration-400 h-full" />
               <div className="w-8 h-full flex justify-center items-center bg-gray-100">
                  <div className="transition-transform group-hover:scale-110">
